...
#ifndef CONTDEFINES_H
#define CONTDEFINES_H
...
#define contactsDBName          "ContactsDB-PAdd"   /**< Contacts DB Name */
#define contactsDBType          'DATA'              /**< Contacts DB Type */
#define contactsFileCAddress    'PAdd'              /**< Contacts DB Creator ID */
...
/*@{*/
#define P1ContactstitleDBType                         'titl'
#define P1ContactstitleDBName                         "AddressTitlesDB"
/*@}*/

/** AutoFill database for the company field. */
/*@{*/
#define P1ContactscompanyDBType                       'cmpy'
#define P1ContactscompanyDBName                       "AddressCompaniesDB"
/*@}*/

/** AutoFill database for the city field. */
/*@{*/
#define P1ContactscityDBType                          'city'
#define P1ContactscityDBName                          "AddressCitiesDB"
/*@}*/

/** AutoFill database for the state field. */
/*@{*/
#define P1ContactsstateDBType                         'stat'
#define P1ContactsstateDBName                         "AddressStatesDB"
/*@}*/

/** AutoFill database for the country field. */
/*@{*/
#define P1ContactscountryDBType                       'cnty'
#define P1ContactscountryDBName                       "AddressCountriesDB"
/*@}*/
...
#define P1ContactsNumDisplayFields    P1ContactsNumFields - (numBirthdayFields -1)

/** Number of fields that are of type string */
#define P1ContactsaddrNumStringFields     P1ContactsNumFields - P1ContactsNumNonStringFields
 ...
 */
#define P1ContactsGetPhoneLabel(r, p) (((r)->options.phoneBits >> \
                            (((p) - P1ContactsfirstPhoneField) << 2)) & 0xF)
 ...
 * @return      Nothing.
 */
#define contactsSetPhoneLabel(r, p, pl) ((r)->options.phoneBits =               \
 ...
 */
#define GetChatLabel(r, p) (((r)->options.chatBits >> (((p) - P1Contactschat1) << 2)) & \
                            0xF)
...
#define P1ContactsisPictureField(fieldIndex) (fieldIndex == pictureInfo)
 ...
 */
#define P1ContactsisPhoneField(f) (f >= P1ContactsfirstPhoneField && f <= P1ContactslastPhoneField)
 ...
 */
#define P1ContactsisAddressField(fieldIndex) (fieldIndex == P1Contactsaddress || fieldIndex == P1Contactsaddress2 || fieldIndex == P1Contactsaddress3)
 ...
 */
#define P1ContactsisChatField(fieldIndex) (fieldIndex == P1Contactschat1 || fieldIndex ==P1Contactschat2)
 ...
 */
#define P1ContactsisPopupTypeField(fieldIndex) (isPhoneField(fieldIndex)   || \
...
#define P1ContactsaddrPrefVersionNum          0x01 //0x04
#define P1ContactsaddrPrefID                  0x00
